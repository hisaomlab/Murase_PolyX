...
# ========================= ユーザー設定（入出力・描画） =========================
# --- 入力ファイル ---
TECAN_file_name = "/Users/muraseyukihiro/Desktop/PolyX_paper/new/fig3/P2A/20251011_EGFP_P2A_PolyX.xlsx" #TECANのraw_dataを指定
sample_sheet_name = "/Users/muraseyukihiro/Desktop/PolyX_paper/new/fig3/P2A/Sample_Sheet_Poly10X.xlsx" #サンプルシートを指定

# --- 出力先 ---
path = "/Users/muraseyukihiro/Desktop/PolyX_paper/new/fig3/P2A"#保存先のパス
plate_visualization_file = f'{path}/platedata.xlsx' #最大蛍光値・MGRを保存するファイル
lineplot_file = f'{path}/lineplot.png' #lineplotを保存するファイル
mainplot_file = f'{path}/mainplot_103.png' #mainplotを保存するファイル
NIplot_file = f'{path}/NIplot_103.png'#NIplotを保存するファイル
...
MFI_YLIM = [0, 10000]           # MFIのylim
NI_YLIM = [0, 20000]     # NIのylim
TITLE = "EGFP-P2A-PolyX (SC-LU)"      # 図のタイトル
#-----------------------------
