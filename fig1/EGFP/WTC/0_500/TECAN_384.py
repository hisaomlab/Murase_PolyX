...
# ========================= ユーザー設定（入出力・描画） =========================
# --- 入力ファイル ---
TECAN_file_name = "/Users/muraseyukihiro/Desktop/PolyX_paper/new/fig1/EGFP/WTC/0_500/20250623_WTCpro_EGFP_PolyX_aTc4ponts.xlsx" #TECANのraw_dataを指定
sample_sheet_name = "/Users/muraseyukihiro/Desktop/PolyX_paper/new/fig1/EGFP/WTC/0_500/Sample_Sheet.xlsx" #サンプルシートを指定

# --- 出力先 ---
path = "/Users/muraseyukihiro/Desktop/PolyX_paper/new/fig1/EGFP/WTC/0_500"#保存先のパス

# --- サンプルの表示順（凡例・プロット順など）---
sample_name = ['Δ','A', 'C', 'D', 'E', 'F', 'G', 'H', 'I', 'K', 'L', 'M', 'N','P', 'Q', 'R','S','T','V','W','Y'] #サンプル名前を指定
MDs = ["_0_", "_50_", "_150_", "_500_" ]
