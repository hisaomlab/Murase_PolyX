...
# ========================= ユーザー設定（入出力・描画） =========================
# --- 入力ファイル ---
TECAN_file_name = "/Users/muraseyukihiro/Desktop/PolyX_paper/new/fig2/PolyX_AAcost/20251024_PolyX_AAcost.xlsx" #TECANのraw_dataを指定
sample_sheet_name = "/Users/muraseyukihiro/Desktop/PolyX_paper/new/fig2/PolyX_AAcost/Sample_Sheet_Poly10X.xlsx" #サンプルシートを指定

# --- 出力先 ---
path = "/Users/muraseyukihiro/Desktop/PolyX_paper/new/fig2/PolyX_AAcost"#保存先のパス
...
# --- サンプルの表示順（凡例・プロット順など）---
sample_name = ['ΔF_x1','ΔF_x2', 'ΔF_x4', 'F_x1','F_x2', 'F_x4', 'ΔI_x1','ΔI_x2', 'ΔI_x4', 'I_x1','I_x2', 'I_x4', 'ΔW_x1','ΔW_x2', 'ΔW_x4', 'W_x1','W_x2', 'W_x4', 'ΔY_x1','ΔY_x2', 'ΔY_x4', 'Y_x1','Y_x2', 'Y_x4'] #サンプル名前を指定

# --- ラインプロット描画設定 ---
FIN_TIME_HOUR =76        # x軸上限 [hour]
GROWTH_YLIM = (0, 1.5)    # 増殖曲線のylim
GROWTH_YTICKS = [0.5, 1.0, 1.5]
FI_YLIM = (0, 25000)     # GFP曲線のylim
FI_YTICKS = [10000, 20000, 25000]
...
MFI_YLIM = [0, 25000]           # MFIのylim
NI_YLIM = [0, 20000]     # NIのylim
TITLE = "EGFP-PolyX (SC-LU + AA+)"      # 図のタイトル
#-----------------------------
...
def calculation(Growth_df: pd.DataFrame, FI_df: pd.DataFrame):
    ...
    base_samples = [s for s in ["ΔF_x1_1", "ΔF_x1_2", "ΔF_x1_3", "ΔF_x1_4"] if s in MGR.index]
...
def create_mainplot(results):
   ...
   # MGR 平均値と標準偏差の棒グラフ
    ...
    # ラベルとタイトルの設定
    ax.set_title(f'MGR and MFI: {TITLE}', fontsize=12)
...
def create_NIplot(results):
   ...
   # NI 平均値と標準偏差の棒グラフ
    ...
    # ラベルとタイトルの設定
    ax.set_title(f'NI: {TITLE}', fontsize=12)
