...
#-----読み込むファイルの指定-----
TECAN_file_name = "/Users/muraseyukihiro/Desktop/PolyX_paper/new/fig2/mScarlet-I/20250125_mScarlet_PolyX_65h.xlsx" #TECANのraw_dataを指定
sample_sheet_name = "/Users/muraseyukihiro/Desktop/PolyX_paper/new/fig2/mScarlet-I/Sample_Sheet_Poly10X.xlsx" #サンプルシートを指定
...
path = "/Users/muraseyukihiro/Desktop/PolyX_paper/new/fig2/mScarlet-I"#保存先のパス
...
def create_lineplot(growth_df, rfp_df):
    ...
    for n, AA in zip(range(len(sample_name)), sample_name):
        ...
        plot_filled_line(ax2, AA, rfp_data, time, color="#FF7EF0", label="_nolegend_", ylim=(0, 25000), yticks=[5000, 15000, 25000])
...
def create_mainplot(MGR, RFP, df, df_mean, df_sd, p_adj_mgr, p_adj_rfp):
   ...
   # MGR 平均値と標準偏差の棒グラフ
    ...
    ax.set_title('MGR and MFI: mScarlet-PolyX (SC-LU)', fontsize=14)
...
def create_NIplot(NI, df, df_mean, df_sd, p_adj_ni):
   ...
   # NI 平均値と標準偏差の棒グラフ
    ...
    ax.set_title('NI: mScarlet-PolyX (SC-LU)', fontsize=14)
