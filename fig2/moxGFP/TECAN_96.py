...
# ========================= ユーザー設定（入出力・描画） =========================
# --- 入力ファイル ---
TECAN_file_name = "/Users/muraseyukihiro/Desktop/PolyX_paper/new/fig2/moxGFP/20241001_WTCpro_mox_PolyX_LU_combine.xlsx" #TECANのraw_dataを指定
sample_sheet_name = "/Users/muraseyukihiro/Desktop/PolyX_paper/new/fig2/moxGFP/Sample_Sheet_Poly10X.xlsx" #サンプルシートを指定

# --- 出力先 ---
path = "/Users/muraseyukihiro/Desktop/PolyX_paper/new/fig2/moxGFP"#保存先のパス
plate_visualization_file = f'{path}/platedata.xlsx' #最大蛍光値・MGRを保存するファイル
lineplot_file = f'{path}/lineplot.png' #lineplotを保存するファイル
mainplot_file = f'{path}/mainplot_63.png' #mainplotを保存するファイル
NIplot_file = f'{path}/NIplot_63.png'#NIplotを保存するファイル
...
FI_YLIM = (0, 1500)     # GFP曲線のylim
FI_YTICKS = [500, 1000, 1500]
...
MFI_YLIM = [0, 1500]           # MFIのylim
NI_YLIM = [0, 20000]     # NIのylim
TITLE = "moxGFP-PolyX (SC-LU)"      # 図のタイトル
#-----------------------------
