...
#-----読み込むファイルの指定-----
TECAN_file_name = "/Users/muraseyukihiro/Desktop/PolyX_paper/new/fig2/Gamillus/20250111_Gamilus_PolyX.xlsx" #TECANのraw_dataを指定
sample_sheet_name = "/Users/muraseyukihiro/Desktop/PolyX_paper/new/fig2/Gamillus/Sample_Sheet_Poly10X.xlsx" #サンプルシートを指定
...
path = "/Users/muraseyukihiro/Desktop/PolyX_paper/new/fig2/Gamillus"#保存先のパス
...
def create_lineplot(growth_df, gfp_df):
    ...
    for n, AA in zip(range(len(sample_name)), sample_name):
        ...
        plot_filled_line(ax2, AA, gfp_data, time, color="#58C9A7", label="_nolegend_", ylim=(0, 20000), yticks=[5000, 10000, 20000])
...
def create_mainplot(MGR, GFP, df, df_mean, df_sd, p_adj_mgr, p_adj_gfp):
   ...
   # MGR 平均値と標準偏差の棒グラフ
    ...
    ax2.set_ylim([0, 20000])  # GFPの範囲で設定
    ...
    ax.set_title('MGR and MFI: Gamillus-PolyX (SC-LU)', fontsize=14)
...
def create_NIplot(NI, df, df_mean, df_sd, p_adj_ni):
   ...
   # NI 平均値と標準偏差の棒グラフ
    ...
    ax.set_title('NI: Gamillus-PolyX (SC-LU)', fontsize=14)
